...
var DIST_PATH = path.join(ROOT_PATH, '../../../../../static/app/game/v44/redux');
var TEM_PATH = path.join(ROOT_PATH, './');
...
module.exports = function(options) {
  ...
  var port = options.port ? options.port : 3001;
	...
	var publicPath = !options.debug?"/app/game/v44/redux/":(options.devServer ?
	...
	var output = {
		...
		chunkFilename: (options.devServer ? "[id].js" : "[name].chunk.js") + (options.longTermCaching? "?[chunkhash:8]" : ""),
